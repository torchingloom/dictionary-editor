...
webFXTreeHandler.reload = function (id) { try {if(this.all[id]) if(this.all[id].parentNode) {this.all[id].parentNode.reload(); return true;}} catch(e) {return false;} };
webFXTreeHandler.expand = function (id) { if(this.all[id]) if(this.all[id].expand) this.all[id].expand(); };
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, eParent, sIcon, sOpenIcon, id) {
	// call super
	this.WebFXTreeItem = WebFXTreeItem;
	this.WebFXTreeItem(sText, sAction, eParent, sIcon, sOpenIcon, id);
